...
public class UpperPredicateOneRow extends TwoPlacePredicate{
    ...
    override public function evaluate(data:Dictionary):Boolean {
        ...
        return operand1.y>operand2.y && operand1.x==operand2.x;
    }


    public override function toString():String {
        return quantsToSts()+"uprow-"+formalOperand1+"-"+formalOperand2+"";
    }
