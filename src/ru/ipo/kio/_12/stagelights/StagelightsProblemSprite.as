...
/**
	...
	public class StagelightsProblemSprite extends Sprite
	{
		...
		public function StagelightsProblemSprite(readonly:Boolean, id:String = null)
		{
			...
			result0.text = "Ваш результат для I фокуса: исчезновение на " + int(results(1)) + "%";
			...
			max0.text = "Лучший результат для I фокуса: исчезновение на " + int(firstMax) + "%";
			...
			result1.text = "Ваш результат для II фокуса: исчезновение на " + int(results(0)) + "%";
			...
			max1.text = "Лучший результат для II фокуса: исчезновение на " + int(secondMax) + "%";
			max1.visible = false;
