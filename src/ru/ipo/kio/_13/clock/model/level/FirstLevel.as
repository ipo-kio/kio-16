/**
 * —пецифичные операции дл€ первого уровн€
 * @author: Vasiliy
 * @date: 21.02.13
 */
...
public class FirstLevel extends SilhouettesProductDrawer implements ITaskLevel {
    ...
    //массив содержит углы в пор€дке обхода их стрелкой, соответствующие им картинки и рассто€ние до новой картинки
    //это необходимо дл€ логики обхода за два оборота (день, ночь)
