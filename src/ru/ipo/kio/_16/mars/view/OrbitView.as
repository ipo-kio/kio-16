...
public class OrbitView extends Sprite {
    ...
    private var _use_ellipses:Boolean;

    public function OrbitView(ss:SpaceSystem, o:Orbit, scale:Number, color:uint, alpha:Number, use_ellipses:Boolean = false) {
        _ss = ss;
        _o = o;
        _scale = scale;
        _color = color;
